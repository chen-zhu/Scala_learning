...
os.system("timeout 10 scala -J-Xss250m cs162.lapel.Interpreter good/append0.lpl &> /dev/null | awk '{if ($0 == \"========\" && count < 10) {print $0; count++;} else if ($0 != \"========\" && count < 10) {print $0;} else {exit 0;}}'")
